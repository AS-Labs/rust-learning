...
impl Game {
    ...
    pub fn key_down(&mut self, key: keyboard::Key) {
        ...
        match key {
            Key::H | Key::Left => self.snake.set_dir(Direction::Left),
            Key::K | Key::Up => self.snake.set_dir(Direction::Up),
            Key::L | Key::Right => self.snake.set_dir(Direction::Right),
            Key::J | Key::Down => self.snake.set_dir(Direction::Down),
            _ => {}
        }
    }
